...
SQL supports several different data types. You can find out about those supported by Presto [here](https://prestodb.github.io/docs/0.172/language/types.html).
