...
Standard:
Requires reason why you need to access the lower level database tables
The above and,
Access to the database (except for tables that hold personal identifiers such as names and addresses)

Full:
Requires reason why you need to access personal identifiers
Level 1 and 2
